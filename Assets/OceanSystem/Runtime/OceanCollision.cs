...
namespace OceanSystem
{
    ...
    public class OceanCollision
    {
        ...
        public bool GetWaterData(Vector3 position, out Vector3 waterPosition, out Vector3 waterNormal)
        {
            ...
            waterPosition = new Vector3(waterPosition.x, displacement.y, waterPosition.z);
            waterNormal = Vector3.Normalize(new Vector3(-displacement.x, 3, -displacement.y));
        ...
        public Vector4 GetWaterDisplacement(Vector3 position)
        {
            Vector4 res = Vector3.zero;
        ...
        private Vector4 GetWaterDisplacement(Vector3 position, int cascade)
        {
        ...
        {
            Vector4 derivatives = GetWaterDisplacement(position);
            float m = 0.001f;
            Vector2 slope = new Vector2(derivatives.x,
                derivatives.y);
            return Vector3.Normalize(new Vector3(-slope.x, 3, -slope.y));
        }

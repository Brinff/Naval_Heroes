...
//               {
//                  Handles.DrawSolidArc(turret.turretBarrels.position, turret.turretBarrels.up, turret.turretBarrels.forward, turret.rightTraverseLimit, ArcSize);
//                  Handles.DrawSolidArc(turret.turretBarrels.position, turret.turretBarrels.up, turret.turretBarrels.forward, -turret.leftTraverseLimit, ArcSize);
//               }
//               else
//               {
...
//            {
//               Handles.color = new Color(1.0f, 0.5f, 0.5f, 0.1f);
//               Handles.DrawSolidArc(transform.position, transform.up, transform.forward, turret.leftTraverseLimit, ArcSize);
//               Handles.DrawSolidArc(transform.position, transform.up, transform.forward, -turret.leftTraverseLimit, ArcSize);

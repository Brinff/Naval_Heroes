    ...
    public void Run(IEcsSystems systems)
    {
        ...
        foreach (var entity in m_Filter)
        {
            ...
            if (abilityState.isPerfrom)
            {
                ...
                CannonProjectile cannonProjectile = new CannonProjectile() { damage = statDamage.value / weaponCannon.barels.Length, owner = root.entity, scatterAngleMin = 0f, scatterAngleMax = 0.2f, timeFactor = 2, velocity = 200, team = teamId };

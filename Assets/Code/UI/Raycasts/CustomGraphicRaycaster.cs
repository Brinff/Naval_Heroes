...
public class CustomGraphicRaycaster : BaseRaycaster, ITargetRaycaster
{
    ...
    private Dictionary<GameObject, Graphic[]> m_TargetRaycast = new Dictionary<GameObject, Graphic[]>();
    ...
    public void AddTargetRaycast(GameObject gameObject)
    {
        ...
        {
            m_TargetRaycast.Add(gameObject, gameObject.GetComponentsInChildren<Graphic>());
        }
    }
    ...
    public IList<Graphic> GetTragetGraphicRaycast()
    {
        List<Graphic> graphics = new List<Graphic>();
        foreach (var item in m_TargetRaycast)
        {
            graphics.AddRange(item.Value.Where(x => x != null && x.canvasRenderer));
        }
        return graphics;
    }
    ...
    public override void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList)
    {
        ...
        var canvasGraphics = m_IsOverrideTargetRaycasts ? GetTragetGraphicRaycast() : GraphicRegistry.GetRaycastableGraphicsForCanvas(canvas);
        ...
        Vector3 eventPosition = CustomRaycastUtility.RelativeMouseAtScaled(eventData.position);
